...
public class StreamPipeline {
	 ...
	 * 
	 * 중간처리 스트림역할 : 필요한 데이터 검색 및 필터링, 형변환(filter, map, sort..
	...
	public static void main(String[] args) {
		...
		pList.add(new Product("갤럭시 z플립4",1050000,10,"삼성"));
		pList.add(new Product("갤럭시 z플립4",1450000,10,"애플"));
		pList.add(new Product("갤럭시 z플립4",950000,10,"애플"));
		 ...
		 * 람다 표현식이 단 하나의 메소드만 참조하는경우 매개변수를 제거해서 사용할 수 있도록함.
		 * 
		 * [표현법]
		 * 클래스 이름 or 변수이름 :: 메소드 이름
		 * 
		 * 
		 */
