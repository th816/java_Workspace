...
public class F_Logical {
	 ...
	 * 
	 * AND 연산자 : 논리값 && 논리값
	 * 			  왼쪽, 오른쪽 논리값이 둘다 TRUE여야 최종결과가 TRUE가 반환됨/
	 * 
	 * OR 연산자 : 논리값 || 논리값
	...
	public void method2() {
		...
		// 사용자가 입력한 값이 1이상 100이하 입니까 ? true/falase
	...
	public void method4() {
		...
		/*
		 * 뒤에 비교연산 구문이 Dead code라고 뜬다.
		 * 실행할때 오류는 나지 않지만, result1 결과값이 어차피 false인데 왜 작성한 구문인지 물어보는것
		 * 
		 */
