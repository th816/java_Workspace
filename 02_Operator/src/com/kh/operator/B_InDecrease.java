...
public class B_InDecrease {
	...
	public void method1( ) {
		...
		System.out.println("1회 수행후 결과 : "+ ++num);//10에서 증감을 먼저 실행하여 11로 num값을 증가시키고
		// 최종적으로 11이 출력됨.
		...
		System.out.println("1회 수행후 결과 : "+ num2++);//10 출력 후 1증가
	...
	System.out.println("a :"+a+", b : "+" c: "+c);// 13, 20 ,29
	}
