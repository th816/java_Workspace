package com.kh.chap05_constructor.mode.vo;
...
public class User {
	 ...
	 * 즉, 어찌됏던간에 기본생성자는 항상 작성하는 습관을 들이자.
	 */
//	
	public User() {
//		/*
...
//		 * JVM이 클래스를 컴파일할때 기본생성자가 없는경우 항상 자동으로 만들어주기 때문.(매개변수있는 생성자가 없는경우)
//		 * 단, 매개변수가 있는 생성자가 이미 클래스안에 작성되어 있는경우 반드시 기본생성자도 함께 작성해줘야한다.
...
//		 */
	...
	public User(String userId, String userPwd, String userName, int age, char gender) {
		...
		/*
		 * 생성자 내부에서 생성자끼리 중복되는 코드가 있는경우, this생성자를 통해 같은클래스 내에있는 다른생성자
