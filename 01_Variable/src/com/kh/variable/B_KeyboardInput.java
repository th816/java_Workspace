...
public class B_KeyboardInput {
	...
	public void inputTest1() {
		 ...
		 * Scanner클래스 안에서 작성되어있는 메소드를 호출해서 이용.
		 */
		...
		// 입력받고자 하는 내용을 먼저 출력문을통해서 입력을 유도.
		...
		//nextLine() : 사용자가 입력한 값 중 개행이 있을 경우 공배겡 무관하게 개행 
		//			   이전까지만 출력해준다.
		//			   특히 사용자가 입력한 값에 공백이 포함될 여지가 있는경우
		//             안전하게 nextLine()합수를 쓰자
	 ...
	 *  sc.nextLine()메소드를 한번 더 실행시켜줘서 버퍼에 남아있는 엔터를 배줘야 한다.
	 *  
	 *  2) '문자' 값을 입력받아야할경우
