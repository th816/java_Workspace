...
public class B_Switch {
	 ...
	 * }				  // 않다면, default내의 실행할코드가 실행된다.
	 * 
	 * switch문 자주사용되진 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과 수행되어야 하는경우
	 * ex) 키보드입력, 마우스입력등.
	 * 
	 * 
	 */
...
//		}
	...
	public void method2() {
		...
		// 잘못된 "과일입력시 저희가게에서는 판매하는 과일이 아닙니다"
	  ...
	  switch(fruit) {
         ...
         default:
				 System.out.println("저희가게에서는 판매하는 과일이 아닙니다");
				 method2();
				 return;
