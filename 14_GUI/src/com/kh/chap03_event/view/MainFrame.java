...
public class MainFrame extends javax.swing.JFrame {
	...
	public MainFrame() {
		...
		// plusBtn 클릭시 => 두개의 정수값을 가져온 후 덧셈 연산 결과를 result 텍스트 상자에 출력
		...
		// ActionListnener : 인터페이스이기 때문에 곧바로 생성 불가
		// 단, 여기서 생성을 하고 싶다면 " 미완성된 메소드"를 완성시키면서 생성 => 익명 클래스 방식
		
		
		
		// minusBtn 클릭 시 => 두개의 정수값을 가져온 후 뺄셈연산 결과를 result 텍스트박스에 출력.
		...
		JLabel title = new JLabel("두 개의 정수를 입력하세요.",0); // 0은 가운데 정렬
