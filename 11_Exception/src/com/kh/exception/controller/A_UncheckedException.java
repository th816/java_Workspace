...
public class A_UncheckedException {
	 ...
	 * -ArrayIndexOutOfBooundsException : 배열의 부적절한 인덱스로 접글할때 발생하는 예외
	 ...
	 * -....
	 * 
	 * => 이러한 RuntimeException과 관련된 예외는 충분히 예상 가능한 상황이기때문에
...
//		if(num2 ==0) {
//			System.out.println("0으로 너눌 수 없습니다");
//		}else {
...
//		
	...
	public void method2() {
		...
		System.out.println("나눗셈 연산 결과 : "+(10 / num)); // ArithmeticException 발생가능
		} catch(ArithmeticException e) {
			System.out.println("0으로 나눌수 없습니다");
	...
	public void method3() {
		// ArrayIndexOutOfBoundsException : 배열의 부적절한 인덱스로 접글할때 발생하는 예외
		// NegativeArraySizeException : 배열의 크기를 음수로 지정할 경우 발생하는 예외
...
//		if(size >0) { // 방법 1. if문으로 size값이 양수일때만 생성하도록 제어.
//		int arr[] = new int[size]; // 방법2. 항상 양의 정수값이 들어갈수 있도록 abs메서드 사용
//		}
...
//		
		try {
			...
			System.out.println("예외가 발생하긴 했는데 배열의 크기를 음수로 입력했거나, 부적절한"
					+ "인덱스로 접근한것 같습니다");
